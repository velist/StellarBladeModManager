...
class ConfigManager:
    def __init__(self):
        ...
        if "default_category_name" in self.config:
            ...
            print(f"[调试] ConfigManager初始化: 加载自定义默认分类名称: {self.default_category_name}")
    ...
    def rename_category(self, old_name, new_name):
        ...
        if old_name in categories:
            ...
            if old_name == self.default_category_name:
                ...
                print(f"[调试] rename_category: 默认分类已重命名为 {new_name}")
        ...
        self.set_categories(categories)
        # 更新配置中的默认分类名称
        self.set("default_category_name", self.default_category_name)
